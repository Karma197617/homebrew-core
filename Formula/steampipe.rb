class Steampipe < Formula
  ...
  # TODO, check completion and test for new version bumps
  ...
  def install
    ...
    # Currently it has `/Users/brew/.steampipe: mkdir /Users/brew/.steampipe: operation not permitted` issue
    # upstream issue report, https://github.com/turbot/steampipe/issues/3485s
    # generate_completions_from_executable(bin/"steampipe", "completion")
  end

  test do
    # revisit this test after completion issue is fixed
